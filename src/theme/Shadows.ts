...
export default class Shadows {
    ...
    public static BOX_SHADOW_LEFT_1: IFilter = new BoxShadowFilter(-4, 0, 3, NaN, new Color(0, 0, 0, 0.07));
    public static BOX_SHADOW_LEFT_2: IFilter = new BoxShadowFilter(-2, 0, 2, NaN, new Color(0, 0, 0, 0.06));
}
